...
static int st7701_enable(struct udevice *dev)
{
	struct st7701_panel_priv *priv = dev_get_priv(dev);
...
static int st7701_panel_probe(struct udevice *dev)
{
	struct st7701_panel_priv *priv = dev_get_priv(dev);
	int ret;
	u32 video_mode;

	printf("st7701_panel_probe");
...
static int st7701_panel_disable(struct udevice *dev)
{
	struct st7701_panel_priv *priv = dev_get_priv(dev);
	printf("st7701_panel_disable");
...
static const struct udevice_id st7701_panel_ids[] = {
	{ .compatible = "sitronix,st7701" },
	{ }
};

U_BOOT_DRIVER(st7701_panel) = {
	.name			  = "st7701_panel",
	.id				  = UCLASS_PANEL,
	.of_match		  = st7701_panel_ids,
	.ops			  = &st7701_panel_ops,
	.probe			  = st7701_panel_probe,
	.remove			  = st7701_panel_disable,
	.platdata_auto_alloc_size = sizeof(struct mipi_dsi_panel_plat),
	.priv_auto_alloc_size	= sizeof(struct st7701_panel_priv),
};
